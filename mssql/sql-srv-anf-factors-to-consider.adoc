...
summary: Esta seção descreve os diferentes problemas que você deve considerar ao usar o Azure NetApp Files com SQL Server na nuvem. 
---
...
* Os seguintes caminhos UNC são suportados: `\\ANFSMB-b4ca.anf.test\SQLDB` e `\\ANFSMB-b4ca.anf.test\SQLDB\`.
