...
----
+
Para obter requisitos detalhados de firewall, consulte link:https://learn.microsoft.com/en-us/troubleshoot/windows-server/networking/service-overview-and-network-port-requirements["Requisitos de serviço e porta de rede do Windows Server"^].
